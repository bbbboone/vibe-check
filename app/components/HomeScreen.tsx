...
export function HomeScreen({ onStart, user, authLoading }: HomeScreenProps) {
  return (
    <div
      className="flex flex-col items-center justify-center h-full px-6 md:px-8 text-center relative overflow-hidden"
      style={{ backgroundColor: '#121212' }}
    >
      {/* Background glow */}
      <div
        className="absolute top-[-80px] left-[-80px] w-[300px] h-[300px] rounded-full blur-[120px] opacity-20"
        style={{ backgroundColor: '#1DB954' }}
      />
      <div
        className="absolute bottom-[-60px] right-[-60px] w-[250px] h-[250px] rounded-full blur-[100px] opacity-10"
        style={{ backgroundColor: '#1DB954' }}
      />
      ...
      <h2 className="text-2xl md:text-3xl font-semibold mb-3 relative z-10" style={{ color: '#FFFFFF' }}>
        지금 기분이 어때?
      </h2>

      <p className="text-base mb-10 max-w-xs leading-relaxed relative z-10" style={{ color: '#B3B3B3' }}>
        ...
        {authLoading ? (
          ...
          <div className="flex flex-col items-center gap-4">
            <div
              ...
              style={{ backgroundColor: '#282828', borderColor: '#3E3E3E' }}
            >
              {user.image ? (
                ...
                <div
                  ...
                  style={{ backgroundColor: '#1DB95426' }}
                >
                  🎵
                </div>
              )}
          ...
          <div className="flex flex-col items-center gap-3">
            <a
              href="/api/auth/login"
              className="flex items-center justify-center gap-3 w-full py-4 rounded-full font-bold text-base transition-all duration-200 active:scale-95"
              style={{ backgroundColor: '#1DB954', color: '#000000' }}
              onMouseEnter={(e) => (e.currentTarget.style.backgroundColor = '#1ED760')}
              onMouseLeave={(e) => (e.currentTarget.style.backgroundColor = '#1DB954')}
            >
